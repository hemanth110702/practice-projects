...
<table>
    ...
    <tr>
        ...
        <td>
            <img src="./screenshots-preview/mobile-home.jpg" width="100%" title="Mobile view - Home"/>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <img src="./screenshots-preview/desktop-result.png" width="100%" title="Desktop view - Result"/>
        </td>
        <td>
            <img src="./screenshots-preview/mobile-result.jpg" width="100%" title="Mobile view - Result"/>
        </td>
    </tr>
</table>
